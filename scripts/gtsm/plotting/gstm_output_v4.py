...
ax4.add_feature(cfeature.LAKES, edgecolor='black', facecolor='white')
...
#ax5.scatter(his_haiyan_TR_max.station_x_coordinate,his_haiyan_TR_max.station_y_coordinate,c='k', marker='x',vmin=-2,vmax=2,zorder=99,edgecolors='k')
...
ax7.set_title('Irma', fontsize=14, fontname='Arial')
...
#ax10.set_title('Irma', fontsize=14, fontname='Arial')
