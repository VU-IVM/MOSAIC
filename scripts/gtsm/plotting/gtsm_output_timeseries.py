...
his_irma_holland_era5 = xr.open_dataset(r'/gpfs/home4/benitoli/gtsm_d3dfm/holland_era5_BS_irma/output/gtsm_fine_0000_his.nc').load()
...
irma_mask_lon2 = (his_irma_holland_era5.station_x_coordinate >= -81.4) & (his_irma_holland_era5.station_x_coordinate <= -81.3)
irma_mask_lat2 = (his_irma_holland_era5.station_y_coordinate >= 31.0) & (his_irma_holland_era5.station_y_coordinate <= 31.2)
his_irma_holland_era5 = his_irma_holland_era5.where(irma_mask_lon2 & irma_mask_lat2, drop = True)
...
his_irma_holland_era5 = his_irma_holland_era5.sel(
    time=slice(start_date, end_date))
#print('irma', his_irma_BS)
...
ax1.plot(his_irma_era5.time,his_irma_era5.waterlevel, 'g', linewidth=1.5, label='ERA5 Baseline configuration')
ax1.plot(his_irma_holland_era5.time,his_irma_holland_era5.waterlevel, 'r',linewidth=1.5, label='ERA5+Holland Baseline configuration')
ax1.plot(his_irma_TR.time,his_irma_TR.waterlevel,  'orange', linewidth=1.5, label='Holland Temporal resolution refined')
ax1.plot(his_irma_BS.time,his_irma_BS.waterlevel, 'b', linewidth=1.5, label='Holland Baseline configuration')
