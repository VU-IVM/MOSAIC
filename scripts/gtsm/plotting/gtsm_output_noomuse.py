...
# load gtsm his data
his_irma_BS_holland_era5 = xr.open_dataset(r'/gpfs/home4/benitoli/gtsm_d3dfm/holland_era5_BS_irma/output/gtsm_fine_0000_his.nc').load()
...
his_irma_TR_holland_era5 = xr.open_dataset(r'/gpfs/home4/benitoli/papers/paper1/scripts/case_studies/irma/no_omuse/holland_era5_TR/output/gtsm_fine_0000_his.nc').load()  
...
his_irma_OR_holland_era5 = xr.open_dataset(r'/gpfs/home4/benitoli/papers/paper1/scripts/case_studies/irma/no_omuse/holland_era5_OR/output/gtsm_fine_0000_his.nc').load()  
...
# load gtsm map data
map_irma_BS_holland_era5 = xr.open_dataset(r'/gpfs/home4/benitoli/gtsm_d3dfm/holland_era5_BS_irma/output/gtsm_fine_0010_map.nc').load() 
map_irma_BS = xr.open_dataset(r'/gpfs/home4/benitoli/papers/paper1/scripts/case_studies/irma/holland_BS/output/gtsm_map.nc').load() 
...
map_irma_TR_holland_era5 = xr.open_dataset(r'/gpfs/home4/benitoli/papers/paper1/scripts/case_studies/irma/no_omuse/holland_era5_TR/output/gtsm_fine_0010_map.nc').load() 
map_irma_TR = xr.open_dataset(r'/gpfs/home4/benitoli/papers/paper1/scripts/case_studies/irma/holland_TR/output/gtsm_map.nc').load()  
...
map_irma_BS_holland_era5_max = map_irma_BS_holland_era5.max('time', skipna=True)
...
his_irma_BS_holland_era5_max = his_irma_BS_holland_era5.max('time', skipna=True)
...
map_irma_TR_holland_era5_max = map_irma_TR_holland_era5.max('time', skipna=True)
...
his_irma_TR_holland_era5_max = his_irma_TR_holland_era5.max('time', skipna=True)
...
his_irma_OR_holland_era5_max = his_irma_OR_holland_era5.max('time', skipna=True)
...
print(his_irma_TR_holland_era5.time)
#%%
...
ax1.scatter(his_irma_BS_holland_era5_max.station_x_coordinate,his_irma_BS_holland_era5_max.station_y_coordinate,c='k', marker='x', cmap=new_cmap,vmin=0.0,vmax=3,zorder=99,edgecolors='k')
...
a1=ax1.tripcolor(map_irma_BS_holland_era5_max.variables['FlowElem_xcc'][:],map_irma_BS_holland_era5_max.variables['FlowElem_ycc'][:],map_irma_BS_holland_era5_max.variables['s1'][:],cmap=new_cmap,vmin=0.0,vmax=3, zorder=1)
...
ax2.scatter(his_haiyan_BS_max.station_x_coordinate,his_haiyan_BS_max.station_y_coordinate,c='k', marker='x', cmap=new_cmap,vmin=0,vmax=7,zorder=99,edgecolors='k')
...
ax3.scatter(his_xynthia_BS_max.station_x_coordinate,his_xynthia_BS_max.station_y_coordinate,c='k', marker='x', cmap=new_cmap,vmin=0,vmax=5,zorder=99,edgecolors='k')
...
ax4.scatter(his_irma_TR_holland_era5_max.station_x_coordinate,his_irma_TR_holland_era5_max.station_y_coordinate,c='k', marker='x', cmap=plt.get_cmap('seismic'),vmin=-0.2,vmax=0.2,zorder=99,edgecolors='k')
#a1=ax1.scatter(map_irma_BS_msk.variables['longitude'][:],map_irma_BS_msk.variables['latitude'][:],c=map_irma_BS_msk.variables['waterlevel'][:], marker='o', cmap=new_cmap,vmin=0,vmax=4,zorder=99,edgecolors='k')
a4=ax4.tripcolor(map_irma_TR_holland_era5_max.variables['FlowElem_xcc'][:],map_irma_TR_holland_era5_max.variables['FlowElem_ycc'][:],(map_irma_TR_holland_era5_max.variables['s1'][:] - map_irma_BS_holland_era5_max.variables['s1'][:]),cmap=plt.get_cmap('seismic'),vmin=-0.2,vmax=0.2, zorder=1)
#ax1.set_extent([-82.5, -79.0, 29.5, 33.0], crs=ccrs.PlateCarree())
...
ax5.scatter(his_haiyan_TR_max.station_x_coordinate,his_haiyan_TR_max.station_y_coordinate,c='k', marker='x', cmap=plt.get_cmap('seismic'),vmin=-2,vmax=2,zorder=99,edgecolors='k')
a5=ax5.tripcolor(map_haiyan_TR_msk.variables['longitude'][:],map_haiyan_TR_msk.variables['latitude'][:],map_haiyan_TR_msk.variables['waterlevel'][:] - map_haiyan_BS_msk.variables['waterlevel'][:],cmap=plt.get_cmap('seismic'),vmin=-2,vmax=2, zorder=1)
#ax2.set_extent([123, 126, 9.5, 12.9], crs=ccrs.PlateCarree())
...
ax6.scatter(his_xynthia_TR_max.station_x_coordinate,his_xynthia_TR_max.station_y_coordinate,c='k', marker='x', cmap=plt.get_cmap('seismic'),vmin=-0.5,vmax=0.5,zorder=99,edgecolors='k')
a6=ax6.tripcolor(map_xynthia_TR_msk.variables['longitude'][:],map_xynthia_TR_msk.variables['latitude'][:],map_xynthia_TR_msk.variables['waterlevel'][:] - map_xynthia_BS_msk.variables['waterlevel'][:] ,cmap=plt.get_cmap('seismic'),vmin=-0.5,vmax=0.5, zorder=1)
#ax3.set_extent([-3.5, -3.5+4*3/3.4, 43.5, 47.5], crs=ccrs.PlateCarree())
...
ax7.scatter(his_irma_OR_holland_era5_max.station_x_coordinate,his_irma_OR_holland_era5_max.station_y_coordinate,c=his_irma_OR_holland_era5_max.waterlevel, marker='o', cmap=new_cmap,vmin=0.0,vmax=3,zorder=99,edgecolors='k')
ax7.scatter(his_irma_BS_holland_era5_max.station_x_coordinate,his_irma_BS_holland_era5_max.station_y_coordinate,c='k', marker='x',vmin=-0.5,vmax=0.5,zorder=99,edgecolors='k')
...
a7=ax7.tripcolor(map_irma_BS_holland_era5_max.variables['FlowElem_xcc'][:],map_irma_BS_holland_era5_max.variables['FlowElem_ycc'][:],map_irma_BS_holland_era5_max.variables['s1'][:],cmap=new_cmap,vmin=0.0,vmax=3, zorder=1)
...
ax8.scatter(his_haiyan_BS_max.station_x_coordinate,his_haiyan_BS_max.station_y_coordinate,c='k', marker='x',vmin=-0.5,vmax=0.5,zorder=99,edgecolors='k')
...
ax9.scatter(his_xynthia_BS_max.station_x_coordinate,his_xynthia_BS_max.station_y_coordinate,c='k', marker='x',vmin=-0.5,vmax=0.5,zorder=99,edgecolors='k')
...
plt.savefig(f"figures/gtsm_output_noomuse.png")
