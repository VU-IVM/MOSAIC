...
ax4.scatter(his_irma_TR_max.station_x_coordinate,his_irma_TR_max.station_y_coordinate,c=his_irma_TR_max.waterlevel - his_irma_BS_max.waterlevel, marker='o', cmap=plt.get_cmap('seismic'),vmin=-0.5,vmax=0.5,zorder=99,edgecolors='k')
...
a4=ax4.tripcolor(map_irma_TR_msk.variables['longitude'][:],map_irma_TR_msk.variables['latitude'][:],(map_irma_TR_msk.variables['waterlevel'][:] - map_irma_BS_msk.variables['waterlevel'][:]),cmap=plt.get_cmap('seismic'),vmin=-0.5,vmax=0.5, zorder=1)
#ax1.set_extent([-82.5, -79.0, 29.5, 33.0], crs=ccrs.PlateCarree())
...
ax5.scatter(his_haiyan_TR_max.station_x_coordinate,his_haiyan_TR_max.station_y_coordinate,c=his_haiyan_TR_max.waterlevel - his_haiyan_BS_max.waterlevel, marker='o', cmap=plt.get_cmap('seismic'),vmin=-2,vmax=2,zorder=99,edgecolors='k')
...
print('map xynthia OR lat', map_xynthia_OR_msk.variables['latitude'][:])
print('map xynthia TR lat', map_xynthia_TR_msk.variables['latitude'][:])
print('map xynthia BS lat',map_xynthia_BS_msk.variables['latitude'][:])
print('map xynthia TR lon', map_xynthia_TR_msk.variables['longitude'][:])
print('map xynthia BS lon',map_xynthia_BS_msk.variables['longitude'][:])

#ax6.set_title('Xynthia', fontsize=14, fontname='Arial')
ax6.plot(xynthia['LON'],xynthia['LAT'],'k',linestyle='--', linewidth=2.0,zorder=4)
ax6.scatter(his_xynthia_TR_max.station_x_coordinate,his_xynthia_TR_max.station_y_coordinate,c=his_xynthia_TR_max.waterlevel - his_xynthia_BS_max.waterlevel , marker='o', cmap=plt.get_cmap('seismic'),vmin=-0.5,vmax=0.5,zorder=99,edgecolors='k')
...
plt.savefig(f"figures/gtsm_output_diff.png")
