...
his_haiyan = xr.open_dataset(r'/gpfs/home4/benitoli/papers/paper1/scripts/case_studies/haiyan/holland_tides/output/omuse_0000_his.nc').load() 
...
map_haiyan = xr.open_dataset(r'/gpfs/home4/benitoli/papers/paper1/scripts/case_studies/haiyan/holland_tides/output/gtsm_map.nc').load() 
...
#%%
# max calculation and removal of dry cells
...
his_irma_max = his_irma.max('time', skipna=True)
...
his_xynthia_max = his_xynthia.max('time', skipna=True)
...
a1=ax1.scatter(his_irma_max.station_x_coordinate,his_irma_max.station_y_coordinate,c=his_irma_max.waterlevel, marker='o', cmap=new_cmap,vmin=0,vmax=4,zorder=99,edgecolors='none')
...
a2=ax2.scatter(his_haiyan_max.station_x_coordinate,his_haiyan_max.station_y_coordinate,c=his_haiyan_max.waterlevel, marker='o', cmap=new_cmap,vmin=0,vmax=6,zorder=99,edgecolors='none')
#a2=ax2.tripcolor(map_haiyan_msk.variables['longitude'][:],map_haiyan_msk.variables['latitude'][:],map_haiyan_msk.variables['waterlevel'][:],cmap=new_cmap,vmin=0,vmax=4, zorder=1)
...
a3=ax3.scatter(his_xynthia_max.station_x_coordinate,his_xynthia_max.station_y_coordinate,c=his_xynthia_max.waterlevel, marker='o', cmap=new_cmap,vmin=0,vmax=5,zorder=99,edgecolors='none')
...
lgd=plt.legend(handles=legend_elements, ncol=3, loc = ('lower center'), bbox_to_anchor=(-1.1, -0.2), prop={'size': 12, 'family':'Arial'}, frameon=False)
plt.savefig(f"figures/gtsm_his_output.png", bbox_era_artists=lgd, bbox_inches='tight')
plt.clf()