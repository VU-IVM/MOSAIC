...
a2=ax2.tripcolor(map_haiyan_msk.variables['longitude'][:],map_haiyan_msk.variables['latitude'][:],map_haiyan_msk.variables['waterlevel'][:],cmap=new_cmap,vmin=0,vmax=6, zorder=1)
...
plt.savefig(f"figures/gtsm_map_output_sfincs_area_haiyan.png", bbox_era_artists=lgd, bbox_inches='tight')
plt.clf()